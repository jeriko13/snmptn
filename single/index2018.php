...
<head>
    ...
    <title>Hasil Seleksi SNMPTN 2018</title>
...
<body>
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container" style="padding-top: 10px;">
                <div class="navbar-header">
                    <span id="span1" class="h2">FAKE GENERATOR <a class="snmptn" href="http://www.snmptn.ac.id/">SNMPTN 2018</a></span>
                    <span id="span2" class="h2 hidden">HASIL SELEKSI <a class="snmptn" href="http://www.snmptn.ac.id/">SNMPTN 2018</a></span>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <p>
                ...
                Pengumuman Hasil Seleksi SNMPTN 2018 (PDF)
                </a>
            </p>
            <div class="alert alert-warning">
                Jadwal pencetakan ulang kartu pendaftaran: 25 Maret 2018 - 25 April 2018.
            </div>
            <div id="form" class="well">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-md input-nama" id="nama" name="nama" value="" placeholder="Nabilah Ratna Ayu" style="text-transform:uppercase" autocomplete="off" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-md input-sekolah" id="sekolah" name="sekolah" value="" placeholder="-- SMAN 48 JAKARTA --" style="text-transform:uppercase" autocomplete="off" required="">
                    </div>
                    <div class="form-group">
                ...
                <button class="btn btn-primary" id="submitBtn" name="submit">Buat Temanmu Bangga!</button>
                </form>
            </div>
            ...
            <div class="alert alert-success hidden" id="divResult">
                <table style="width: 100%">
                    <tbody><tr>
                        <td>
                            <p><strong>Selamat, Anda dinyatakan lulus SNMPTN 2018 pada</strong></p>
            ...
            <div class="alert alert-warning hidden" id="divInfoResult1">
                ...
                <p>Status penerimaan Anda sebagai mahasiswa di PTN tujuan, akan ditentukan berdasarkan verifikasi data akademik
                    ...
                    tanggal 8 Mei 2018 menentukan proses verifikasi dan status penerimaan Anda. Setelah Anda dinyatakan
                ...
                <p>Pengumuman Resmi Panitia Pusat Seleksi Nasional PMB PTN 2018, <a href="http://pengumuman.snmptn.ac.id/pengumuman2019.pdf">klik disini</a>.</p>
            ...
            <div class="alert alert-danger hidden" id="divNotAccepted">
                Anda dinyatakan tidak lulus seleksi SNMPTN 2018. Silakan mengikuti SBMPTN 2018.
            </div>
    ...
    <div id="footer">
        <div class="container">
            <p id="foot1" class="muted">naufalist@2018</p>
            <p id="foot2" class="muted hidden">Panitia Pusat Seleksi Nasional PMB PTN 2018</p>
